...
import { Party, PartyParticipant } from "./party";
import {
  Session,
  SessionDetail,
  SessionFeedback,
...
/** Party Management */
export interface CreateSessionPartyRequest {
  sessionId: number;
  party: Party | undefined;
}

export interface CreateSessionPartyResponse {
  party: Party | undefined;
}

export interface GetSessionPartyRequest {
  sessionId: number;
}

export interface GetSessionPartyResponse {
  party: Party | undefined;
}

export interface AddPartyParticipantRequest {
  sessionId: number;
  participant: PartyParticipant | undefined;
}
...
export interface ListPartyParticipantsRequest {
  sessionId: number;
}

export interface ListPartyParticipantsResponse {
...
export interface DeletePartyParticipantRequest {
  sessionId: number;
  participantId: number;
}

export interface DeletePartyParticipantResponse {
  success: boolean;
}
...
function createBaseAddSessionPartRequest(): AddSessionPartRequest {
  return { sessionId: 0, part: undefined };
}
...
function createBaseUpdateSessionPartRequest(): UpdateSessionPartRequest {
  return { sessionId: 0, partId: 0, part: undefined };
}
...
export const UpdateSessionPartRequest = {
  encode(message: UpdateSessionPartRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.partId !== 0) {
      writer.uint32(16).int32(message.partId);
    }
    if (message.part !== undefined) {
...
function createBaseDeleteSessionPartRequest(): DeleteSessionPartRequest {
  return { sessionId: 0, partId: 0 };
}

export const DeleteSessionPartRequest = {
  encode(message: DeleteSessionPartRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sessionId !== 0) {
      writer.uint32(8).int32(message.sessionId);
    }
    if (message.partId !== 0) {
  ...
  fromJSON(object: any): DeleteSessionPartRequest {
    return {
      sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0,
      partId: isSet(object.partId) ? globalThis.Number(object.partId) : 0,
    };
  ...
  toJSON(message: DeleteSessionPartRequest): unknown {
    const obj: any = {};
    if (message.sessionId !== 0) {
      obj.sessionId = Math.round(message.sessionId);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteSessionPartRequest>, I>>(object: I): DeleteSessionPartRequest {
    const message = createBaseDeleteSessionPartRequest();
    message.sessionId = object.sessionId ?? 0;
    message.partId = object.partId ?? 0;
    return message;
...
export const ListSessionSongsRequest = {
  encode(message: ListSessionSongsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sessionId !== 0) {
      writer.uint32(8).int32(message.sessionId);
    }
    return writer;
  ...
  fromJSON(object: any): ListSessionSongsRequest {
    return { sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0 };
  },

  toJSON(message: ListSessionSongsRequest): unknown {
    const obj: any = {};
    if (message.sessionId !== 0) {
      obj.sessionId = Math.round(message.sessionId);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListSessionSongsRequest>, I>>(object: I): ListSessionSongsRequest {
    const message = createBaseListSessionSongsRequest();
    message.sessionId = object.sessionId ?? 0;
    return message;
  },
...
export const GetSessionSongRequest = {
  encode(message: GetSessionSongRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sessionId !== 0) {
      writer.uint32(8).int32(message.sessionId);
    }
    if (message.songId !== 0) {
  ...
  fromJSON(object: any): GetSessionSongRequest {
    return {
      sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0,
  ...
  toJSON(message: GetSessionSongRequest): unknown {
    const obj: any = {};
    if (message.sessionId !== 0) {
      obj.sessionId = Math.round(message.sessionId);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GetSessionSongRequest>, I>>(object: I): GetSessionSongRequest {
    const message = createBaseGetSessionSongRequest();
    message.sessionId = object.sessionId ?? 0;
...
function createBaseUpdateSessionSongRequest(): UpdateSessionSongRequest {
  return { sessionId: 0, songId: 0, song: undefined };
}
...
export const UpdateSessionSongRequest = {
  encode(message: UpdateSessionSongRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.song !== undefined) {
      SongPerformance.encode(message.song, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): UpdateSessionSongRequest {
    return {
      sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0,
      songId: isSet(object.songId) ? globalThis.Number(object.songId) : 0,
      song: isSet(object.song) ? SongPerformance.fromJSON(object.song) : undefined,
    };
  },
...
export const DeleteSessionSongRequest = {
  encode(message: DeleteSessionSongRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sessionId !== 0) {
      writer.uint32(8).int32(message.sessionId);
    }
    if (message.songId !== 0) {
  ...
  fromJSON(object: any): DeleteSessionSongRequest {
    return {
      sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0,
      songId: isSet(object.songId) ? globalThis.Number(object.songId) : 0,
    };
  ...
  toJSON(message: DeleteSessionSongRequest): unknown {
    const obj: any = {};
    if (message.sessionId !== 0) {
      obj.sessionId = Math.round(message.sessionId);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteSessionSongRequest>, I>>(object: I): DeleteSessionSongRequest {
    const message = createBaseDeleteSessionSongRequest();
    message.sessionId = object.sessionId ?? 0;
    message.songId = object.songId ?? 0;
    return message;
...
function createBaseCreateSessionPartyRequest(): CreateSessionPartyRequest {
  return { sessionId: 0, party: undefined };
}

export const CreateSessionPartyRequest = {
  encode(message: CreateSessionPartyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sessionId !== 0) {
      writer.uint32(8).int32(message.sessionId);
    }
    if (message.party !== undefined) {
      Party.encode(message.party, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CreateSessionPartyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCreateSessionPartyRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): CreateSessionPartyRequest {
    return {
      sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0,
  ...
  toJSON(message: CreateSessionPartyRequest): unknown {
    const obj: any = {};
    if (message.sessionId !== 0) {
      obj.sessionId = Math.round(message.sessionId);
    }
  ...
  create<I extends Exact<DeepPartial<CreateSessionPartyRequest>, I>>(base?: I): CreateSessionPartyRequest {
    return CreateSessionPartyRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateSessionPartyRequest>, I>>(object: I): CreateSessionPartyRequest {
    const message = createBaseCreateSessionPartyRequest();
    message.sessionId = object.sessionId ?? 0;
...
function createBaseCreateSessionPartyResponse(): CreateSessionPartyResponse {
  return { party: undefined };
}

export const CreateSessionPartyResponse = {
  encode(message: CreateSessionPartyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.party !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CreateSessionPartyResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCreateSessionPartyResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): CreateSessionPartyResponse {
    return { party: isSet(object.party) ? Party.fromJSON(object.party) : undefined };
  },

  toJSON(message: CreateSessionPartyResponse): unknown {
    const obj: any = {};
    if (message.party !== undefined) {
      obj.party = Party.toJSON(message.party);
    }
  ...
  create<I extends Exact<DeepPartial<CreateSessionPartyResponse>, I>>(base?: I): CreateSessionPartyResponse {
    return CreateSessionPartyResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateSessionPartyResponse>, I>>(object: I): CreateSessionPartyResponse {
    const message = createBaseCreateSessionPartyResponse();
    message.party = (object.party !== undefined && object.party !== null) ? Party.fromPartial(object.party) : undefined;
    return message;
  },
...
function createBaseGetSessionPartyRequest(): GetSessionPartyRequest {
  return { sessionId: 0 };
}

export const GetSessionPartyRequest = {
  encode(message: GetSessionPartyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sessionId !== 0) {
      writer.uint32(8).int32(message.sessionId);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetSessionPartyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetSessionPartyRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetSessionPartyRequest {
    return { sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0 };
  },

  toJSON(message: GetSessionPartyRequest): unknown {
    const obj: any = {};
    if (message.sessionId !== 0) {
      obj.sessionId = Math.round(message.sessionId);
    }
  ...
  create<I extends Exact<DeepPartial<GetSessionPartyRequest>, I>>(base?: I): GetSessionPartyRequest {
    return GetSessionPartyRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetSessionPartyRequest>, I>>(object: I): GetSessionPartyRequest {
    const message = createBaseGetSessionPartyRequest();
    message.sessionId = object.sessionId ?? 0;
    return message;
  },
...
function createBaseGetSessionPartyResponse(): GetSessionPartyResponse {
  return { party: undefined };
}

export const GetSessionPartyResponse = {
  encode(message: GetSessionPartyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.party !== undefined) {
      Party.encode(message.party, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetSessionPartyResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetSessionPartyResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetSessionPartyResponse {
    return { party: isSet(object.party) ? Party.fromJSON(object.party) : undefined };
  },

  toJSON(message: GetSessionPartyResponse): unknown {
    const obj: any = {};
    if (message.party !== undefined) {
      obj.party = Party.toJSON(message.party);
    }
  ...
  create<I extends Exact<DeepPartial<GetSessionPartyResponse>, I>>(base?: I): GetSessionPartyResponse {
    return GetSessionPartyResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetSessionPartyResponse>, I>>(object: I): GetSessionPartyResponse {
    const message = createBaseGetSessionPartyResponse();
    message.party = (object.party !== undefined && object.party !== null) ? Party.fromPartial(object.party) : undefined;
    return message;
  },
...
export const AddPartyParticipantRequest = {
  encode(message: AddPartyParticipantRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.participant !== undefined) {
      PartyParticipant.encode(message.participant, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.participant = PartyParticipant.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): AddPartyParticipantRequest {
    return {
      sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0,
      participant: isSet(object.participant) ? PartyParticipant.fromJSON(object.participant) : undefined,
    };
  },
  ...
  toJSON(message: AddPartyParticipantRequest): unknown {
    ...
    if (message.participant !== undefined) {
      obj.participant = PartyParticipant.toJSON(message.participant);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<AddPartyParticipantRequest>, I>>(object: I): AddPartyParticipantRequest {
    ...
    message.sessionId = object.sessionId ?? 0;
    message.participant = (object.participant !== undefined && object.participant !== null)
      ? PartyParticipant.fromPartial(object.participant)
      : undefined;
    return message;
  },
};
...
export const AddPartyParticipantResponse = {
  encode(message: AddPartyParticipantResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.participant !== undefined) {
      PartyParticipant.encode(message.participant, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): AddPartyParticipantResponse {
    return { participant: isSet(object.participant) ? PartyParticipant.fromJSON(object.participant) : undefined };
  },
...
function createBaseListPartyParticipantsRequest(): ListPartyParticipantsRequest {
  return { sessionId: 0 };
}

export const ListPartyParticipantsRequest = {
  encode(message: ListPartyParticipantsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sessionId !== 0) {
      writer.uint32(8).int32(message.sessionId);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPartyParticipantsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListPartyParticipantsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ListPartyParticipantsRequest {
    return { sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0 };
  },

  toJSON(message: ListPartyParticipantsRequest): unknown {
    const obj: any = {};
    if (message.sessionId !== 0) {
      obj.sessionId = Math.round(message.sessionId);
    }
  ...
  create<I extends Exact<DeepPartial<ListPartyParticipantsRequest>, I>>(base?: I): ListPartyParticipantsRequest {
    return ListPartyParticipantsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListPartyParticipantsRequest>, I>>(object: I): ListPartyParticipantsRequest {
    const message = createBaseListPartyParticipantsRequest();
    message.sessionId = object.sessionId ?? 0;
    return message;
  },
...
function createBaseListPartyParticipantsResponse(): ListPartyParticipantsResponse {
  return { participants: [] };
}

export const ListPartyParticipantsResponse = {
  encode(message: ListPartyParticipantsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.participants) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPartyParticipantsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListPartyParticipantsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ListPartyParticipantsResponse {
    return {
      participants: globalThis.Array.isArray(object?.participants)
  ...
  toJSON(message: ListPartyParticipantsResponse): unknown {
    const obj: any = {};
    if (message.participants?.length) {
  ...
  create<I extends Exact<DeepPartial<ListPartyParticipantsResponse>, I>>(base?: I): ListPartyParticipantsResponse {
    return ListPartyParticipantsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListPartyParticipantsResponse>, I>>(
    object: I,
  ): ListPartyParticipantsResponse {
    const message = createBaseListPartyParticipantsResponse();
...
export const UpdatePartyParticipantRequest = {
  encode(message: UpdatePartyParticipantRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.participant !== undefined) {
      PartyParticipant.encode(message.participant, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
...
function createBaseDeletePartyParticipantRequest(): DeletePartyParticipantRequest {
  return { sessionId: 0, participantId: 0 };
}

export const DeletePartyParticipantRequest = {
  encode(message: DeletePartyParticipantRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sessionId !== 0) {
      writer.uint32(8).int32(message.sessionId);
    }
    if (message.participantId !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeletePartyParticipantRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeletePartyParticipantRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DeletePartyParticipantRequest {
    return {
      sessionId: isSet(object.sessionId) ? globalThis.Number(object.sessionId) : 0,
      participantId: isSet(object.participantId) ? globalThis.Number(object.participantId) : 0,
    };
  ...
  toJSON(message: DeletePartyParticipantRequest): unknown {
    const obj: any = {};
    if (message.sessionId !== 0) {
      obj.sessionId = Math.round(message.sessionId);
    }
  ...
  create<I extends Exact<DeepPartial<DeletePartyParticipantRequest>, I>>(base?: I): DeletePartyParticipantRequest {
    return DeletePartyParticipantRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeletePartyParticipantRequest>, I>>(
    object: I,
  ): DeletePartyParticipantRequest {
    const message = createBaseDeletePartyParticipantRequest();
    message.sessionId = object.sessionId ?? 0;
    message.participantId = object.participantId ?? 0;
    return message;
...
function createBaseDeletePartyParticipantResponse(): DeletePartyParticipantResponse {
  return { success: false };
}

export const DeletePartyParticipantResponse = {
  encode(message: DeletePartyParticipantResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeletePartyParticipantResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeletePartyParticipantResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DeletePartyParticipantResponse {
    return { success: isSet(object.success) ? globalThis.Boolean(object.success) : false };
  },

  toJSON(message: DeletePartyParticipantResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
  ...
  create<I extends Exact<DeepPartial<DeletePartyParticipantResponse>, I>>(base?: I): DeletePartyParticipantResponse {
    return DeletePartyParticipantResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeletePartyParticipantResponse>, I>>(
    object: I,
  ): DeletePartyParticipantResponse {
    const message = createBaseDeletePartyParticipantResponse();
    message.success = object.success ?? false;
    return message;
  },
...
export interface SessionService {
  ...
  /**
   * Party Management
   * POST /sessions/{id}/party
   */
  CreateSessionParty(request: CreateSessionPartyRequest): Promise<CreateSessionPartyResponse>;
  /** GET /sessions/{id}/party */
  GetSessionParty(request: GetSessionPartyRequest): Promise<GetSessionPartyResponse>;
  /** POST /sessions/{id}/party/participants */
  AddPartyParticipant(request: AddPartyParticipantRequest): Promise<AddPartyParticipantResponse>;
  /** GET /sessions/{id}/party/participants */
  ListPartyParticipants(request: ListPartyParticipantsRequest): Promise<ListPartyParticipantsResponse>;
  /** PUT /sessions/{id}/party/participants/{participantId} */
  UpdatePartyParticipant(request: UpdatePartyParticipantRequest): Promise<UpdatePartyParticipantResponse>;
  /** DELETE /sessions/{id}/party/participants/{participantId} */
  DeletePartyParticipant(request: DeletePartyParticipantRequest): Promise<DeletePartyParticipantResponse>;
}
...
export class SessionServiceClientImpl implements SessionService {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.CreateSessionParty = this.CreateSessionParty.bind(this);
    this.GetSessionParty = this.GetSessionParty.bind(this);
    this.AddPartyParticipant = this.AddPartyParticipant.bind(this);
    this.ListPartyParticipants = this.ListPartyParticipants.bind(this);
    this.UpdatePartyParticipant = this.UpdatePartyParticipant.bind(this);
    this.DeletePartyParticipant = this.DeletePartyParticipant.bind(this);
  }
  CreateSession(request: CreateSessionRequest): Promise<CreateSessionResponse> {
  ...
  CreateSessionParty(request: CreateSessionPartyRequest): Promise<CreateSessionPartyResponse> {
    const data = CreateSessionPartyRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CreateSessionParty", data);
    return promise.then((data) => CreateSessionPartyResponse.decode(_m0.Reader.create(data)));
  }

  GetSessionParty(request: GetSessionPartyRequest): Promise<GetSessionPartyResponse> {
    const data = GetSessionPartyRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetSessionParty", data);
    return promise.then((data) => GetSessionPartyResponse.decode(_m0.Reader.create(data)));
  }
  ...
  ListPartyParticipants(request: ListPartyParticipantsRequest): Promise<ListPartyParticipantsResponse> {
    const data = ListPartyParticipantsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListPartyParticipants", data);
    return promise.then((data) => ListPartyParticipantsResponse.decode(_m0.Reader.create(data)));
  }
  ...
  DeletePartyParticipant(request: DeletePartyParticipantRequest): Promise<DeletePartyParticipantResponse> {
    const data = DeletePartyParticipantRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeletePartyParticipant", data);
    return promise.then((data) => DeletePartyParticipantResponse.decode(_m0.Reader.create(data)));
  }
}
