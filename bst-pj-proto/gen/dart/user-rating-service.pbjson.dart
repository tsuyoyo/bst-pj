...
const RateUserRequest$json = {
  ...
  '2': [
    ...
    {'1': 'sessionId', '3': 2, '4': 1, '5': 5, '10': 'sessionId'},
...
final $typed_data.Uint8List rateUserRequestDescriptor = $convert.base64Decode(
    'Cg9SYXRlVXNlclJlcXVlc3QSFgoGdXNlcklkGAEgASgFUgZ1c2VySWQSHAoJc2Vzc2lvbklkGA'
    'IgASgFUglzZXNzaW9uSWQSFAoFc2NvcmUYAyABKAVSBXNjb3JlEhgKB2NvbW1lbnQYBCABKAlS'
    'B2NvbW1lbnQ=');
...
final $typed_data.Uint8List getUserRatingBadgesRequestDescriptor = $convert.base64Decode(
    'ChpHZXRVc2VyUmF0aW5nQmFkZ2VzUmVxdWVzdBIWCgZ1c2VySWQYASABKAVSBnVzZXJJZA==');
