...
class Area extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Area', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..a<$core.int>(2, _omitFieldNames ? '' : 'prefectureId', $pb.PbFieldType.O3, protoName: 'prefectureId')
    ..hasRequiredFields = false
  ;
...
class Location extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Location', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOS(3, _omitFieldNames ? '' : 'additionalInfo', protoName: 'additionalInfo')
    ..aOM<Area>(4, _omitFieldNames ? '' : 'area', subBuilder: Area.create)
    ..aOS(5, _omitFieldNames ? '' : 'mapUrl', protoName: 'mapUrl')
    ..hasRequiredFields = false
  ;
