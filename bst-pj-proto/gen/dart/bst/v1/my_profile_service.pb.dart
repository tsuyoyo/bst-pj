...
class UpdateResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$28.UserProfile>(2, _omitFieldNames ? '' : 'profile', subBuilder: $28.UserProfile.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $28.UserProfile get profile => $_getN(1);
  @$pb.TagNumber(2)
  set profile($28.UserProfile v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProfile() => $_has(1);
  @$pb.TagNumber(2)
  void clearProfile() => clearField(2);
  @$pb.TagNumber(2)
  $28.UserProfile ensureProfile() => $_ensure(1);
}
