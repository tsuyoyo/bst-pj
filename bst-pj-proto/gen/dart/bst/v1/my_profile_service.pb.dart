...
class GetMyProfileResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetMyProfileResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$26.UserProfile>(1, _omitFieldNames ? '' : 'profile', subBuilder: $26.UserProfile.create)
  ...
  @$pb.TagNumber(1)
  $26.UserProfile get profile => $_getN(0);
  @$pb.TagNumber(1)
  set profile($26.UserProfile v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProfile() => $_has(0);
  @$pb.TagNumber(1)
  void clearProfile() => clearField(1);
  @$pb.TagNumber(1)
  $26.UserProfile ensureProfile() => $_ensure(0);
...
class UpdateResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$26.UserProfile>(2, _omitFieldNames ? '' : 'profile', subBuilder: $26.UserProfile.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $26.UserProfile get profile => $_getN(1);
  @$pb.TagNumber(2)
  set profile($26.UserProfile v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProfile() => $_has(1);
  @$pb.TagNumber(2)
  void clearProfile() => clearField(2);
  @$pb.TagNumber(2)
  $26.UserProfile ensureProfile() => $_ensure(1);
}
