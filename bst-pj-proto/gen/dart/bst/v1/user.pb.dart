...
class UserFavorite extends $pb.GeneratedMessage {
  factory UserFavorite({
    $core.Iterable<$25.Genre>? genres,
    $core.Iterable<$25.Artist>? artists,
    $core.Iterable<$25.Part>? parts,
  }) {
    final $result = create();
    if (genres != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserFavorite', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..pc<$25.Genre>(1, _omitFieldNames ? '' : 'genres', $pb.PbFieldType.PM, subBuilder: $25.Genre.create)
    ..pc<$25.Artist>(2, _omitFieldNames ? '' : 'artists', $pb.PbFieldType.PM, subBuilder: $25.Artist.create)
    ..pc<$25.Part>(3, _omitFieldNames ? '' : 'parts', $pb.PbFieldType.PM, subBuilder: $25.Part.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$25.Genre> get genres => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<$25.Artist> get artists => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$25.Part> get parts => $_getList(2);
}
