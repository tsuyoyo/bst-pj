...
class DashboardData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DashboardData', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$32.Timestamp>(4, _omitFieldNames ? '' : 'updatedAt', subBuilder: $32.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $32.Timestamp get updatedAt => $_getN(3);
  @$pb.TagNumber(4)
  set updatedAt($32.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUpdatedAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearUpdatedAt() => clearField(4);
  @$pb.TagNumber(4)
  $32.Timestamp ensureUpdatedAt() => $_ensure(3);
}
...
class SearchIndex extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchIndex', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$32.Timestamp>(5, _omitFieldNames ? '' : 'indexedAt', subBuilder: $32.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $32.Timestamp get indexedAt => $_getN(4);
  @$pb.TagNumber(5)
  set indexedAt($32.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasIndexedAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearIndexedAt() => clearField(5);
  @$pb.TagNumber(5)
  $32.Timestamp ensureIndexedAt() => $_ensure(4);
}
