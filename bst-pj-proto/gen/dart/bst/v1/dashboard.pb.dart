...
class DashboardData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DashboardData', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$26.Timestamp>(4, _omitFieldNames ? '' : 'updatedAt', subBuilder: $26.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $26.Timestamp get updatedAt => $_getN(3);
  @$pb.TagNumber(4)
  set updatedAt($26.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUpdatedAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearUpdatedAt() => clearField(4);
  @$pb.TagNumber(4)
  $26.Timestamp ensureUpdatedAt() => $_ensure(3);
}
...
class SearchIndex extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchIndex', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$26.Timestamp>(5, _omitFieldNames ? '' : 'indexedAt', subBuilder: $26.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $26.Timestamp get indexedAt => $_getN(4);
  @$pb.TagNumber(5)
  set indexedAt($26.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasIndexedAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearIndexedAt() => clearField(5);
  @$pb.TagNumber(5)
  $26.Timestamp ensureIndexedAt() => $_ensure(4);
}
