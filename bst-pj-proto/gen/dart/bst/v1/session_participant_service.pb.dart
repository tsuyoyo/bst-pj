...
class ListSessionParticipantsResponse extends $pb.GeneratedMessage {
  factory ListSessionParticipantsResponse({
    $core.Iterable<$37.SessionParticipant>? participants,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListSessionParticipantsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..pc<$37.SessionParticipant>(1, _omitFieldNames ? '' : 'participants', $pb.PbFieldType.PM, subBuilder: $37.SessionParticipant.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$37.SessionParticipant> get participants => $_getList(0);
}
...
class AddSessionParticipantResponse extends $pb.GeneratedMessage {
  factory AddSessionParticipantResponse({
    $37.SessionParticipant? sessionParticipant,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddSessionParticipantResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$37.SessionParticipant>(1, _omitFieldNames ? '' : 'sessionParticipant', protoName: 'sessionParticipant', subBuilder: $37.SessionParticipant.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $37.SessionParticipant get sessionParticipant => $_getN(0);
  @$pb.TagNumber(1)
  set sessionParticipant($37.SessionParticipant v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSessionParticipant() => $_has(0);
  @$pb.TagNumber(1)
  void clearSessionParticipant() => clearField(1);
  @$pb.TagNumber(1)
  $37.SessionParticipant ensureSessionParticipant() => $_ensure(0);
}
...
class UpdateSessionParticipantStatusRequest extends $pb.GeneratedMessage {
  factory UpdateSessionParticipantStatusRequest({
    $37.SessionParticipantStatus? status,
  }) {
    final $result = create();
    if (status != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateSessionParticipantStatusRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..e<$37.SessionParticipantStatus>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $37.SessionParticipantStatus.SESSION_PARTICIPANT_STATUS_UNSPECIFIED, valueOf: $37.SessionParticipantStatus.valueOf, enumValues: $37.SessionParticipantStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $37.SessionParticipantStatus get status => $_getN(0);
  @$pb.TagNumber(1)
  set status($37.SessionParticipantStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
