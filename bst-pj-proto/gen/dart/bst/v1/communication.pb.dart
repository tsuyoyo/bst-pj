...
class Comment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Comment', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$28.Timestamp>(5, _omitFieldNames ? '' : 'createdAt', subBuilder: $28.Timestamp.create)
    ..aOM<$28.Timestamp>(6, _omitFieldNames ? '' : 'updatedAt', subBuilder: $28.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $28.Timestamp get createdAt => $_getN(4);
  @$pb.TagNumber(5)
  set createdAt($28.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCreatedAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearCreatedAt() => clearField(5);
  @$pb.TagNumber(5)
  $28.Timestamp ensureCreatedAt() => $_ensure(4);

  @$pb.TagNumber(6)
  $28.Timestamp get updatedAt => $_getN(5);
  @$pb.TagNumber(6)
  set updatedAt($28.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpdatedAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearUpdatedAt() => clearField(6);
  @$pb.TagNumber(6)
  $28.Timestamp ensureUpdatedAt() => $_ensure(5);
...
class Thread extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Thread', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$29.User>(4, _omitFieldNames ? '' : 'createdBy', subBuilder: $29.User.create)
    ..aOM<$28.Timestamp>(5, _omitFieldNames ? '' : 'createdAt', subBuilder: $28.Timestamp.create)
    ..aOM<$28.Timestamp>(6, _omitFieldNames ? '' : 'updatedAt', subBuilder: $28.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $29.User get createdBy => $_getN(3);
  @$pb.TagNumber(4)
  set createdBy($29.User v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCreatedBy() => $_has(3);
  @$pb.TagNumber(4)
  void clearCreatedBy() => clearField(4);
  @$pb.TagNumber(4)
  $29.User ensureCreatedBy() => $_ensure(3);
...
class ReactionType extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReactionType', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$28.Timestamp>(6, _omitFieldNames ? '' : 'createdAt', subBuilder: $28.Timestamp.create)
    ..aOM<$28.Timestamp>(7, _omitFieldNames ? '' : 'updatedAt', subBuilder: $28.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
class Reaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reaction', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..aOM<$29.User>(2, _omitFieldNames ? '' : 'user', subBuilder: $29.User.create)
  ...
  @$pb.TagNumber(2)
  $29.User get user => $_getN(1);
  @$pb.TagNumber(2)
  set user($29.User v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUser() => $_has(1);
  @$pb.TagNumber(2)
  void clearUser() => clearField(2);
  @$pb.TagNumber(2)
  $29.User ensureUser() => $_ensure(1);
