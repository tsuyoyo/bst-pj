...
class Comment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Comment', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$25.Timestamp>(6, _omitFieldNames ? '' : 'updatedAt', subBuilder: $25.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $25.Timestamp get updatedAt => $_getN(5);
  @$pb.TagNumber(6)
  set updatedAt($25.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpdatedAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearUpdatedAt() => clearField(6);
  @$pb.TagNumber(6)
  $25.Timestamp ensureUpdatedAt() => $_ensure(5);
...
class Thread extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Thread', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$26.User>(4, _omitFieldNames ? '' : 'createdBy', subBuilder: $26.User.create)
    ..aOM<$25.Timestamp>(5, _omitFieldNames ? '' : 'createdAt', subBuilder: $25.Timestamp.create)
    ..aOM<$25.Timestamp>(6, _omitFieldNames ? '' : 'updatedAt', subBuilder: $25.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $26.User get createdBy => $_getN(3);
  @$pb.TagNumber(4)
  set createdBy($26.User v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCreatedBy() => $_has(3);
  @$pb.TagNumber(4)
  void clearCreatedBy() => clearField(4);
  @$pb.TagNumber(4)
  $26.User ensureCreatedBy() => $_ensure(3);
...
class ReactionType extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReactionType', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$25.Timestamp>(6, _omitFieldNames ? '' : 'createdAt', subBuilder: $25.Timestamp.create)
    ..aOM<$25.Timestamp>(7, _omitFieldNames ? '' : 'updatedAt', subBuilder: $25.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $25.Timestamp get updatedAt => $_getN(6);
  @$pb.TagNumber(7)
  set updatedAt($25.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasUpdatedAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearUpdatedAt() => clearField(7);
  @$pb.TagNumber(7)
  $25.Timestamp ensureUpdatedAt() => $_ensure(6);
}
