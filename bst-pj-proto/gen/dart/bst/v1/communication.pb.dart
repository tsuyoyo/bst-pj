...
class Comment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Comment', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$19.Timestamp>(5, _omitFieldNames ? '' : 'createdAt', subBuilder: $19.Timestamp.create)
    ..aOM<$19.Timestamp>(6, _omitFieldNames ? '' : 'updatedAt', subBuilder: $19.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $19.Timestamp get updatedAt => $_getN(5);
  @$pb.TagNumber(6)
  set updatedAt($19.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpdatedAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearUpdatedAt() => clearField(6);
  @$pb.TagNumber(6)
  $19.Timestamp ensureUpdatedAt() => $_ensure(5);
...
class Thread extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Thread', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$20.User>(5, _omitFieldNames ? '' : 'createdBy', subBuilder: $20.User.create)
    ..aOM<$19.Timestamp>(6, _omitFieldNames ? '' : 'createdAt', subBuilder: $19.Timestamp.create)
    ..aOM<$19.Timestamp>(7, _omitFieldNames ? '' : 'updatedAt', subBuilder: $19.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $20.User get createdBy => $_getN(4);
  @$pb.TagNumber(5)
  set createdBy($20.User v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCreatedBy() => $_has(4);
  @$pb.TagNumber(5)
  void clearCreatedBy() => clearField(5);
  @$pb.TagNumber(5)
  $20.User ensureCreatedBy() => $_ensure(4);

  @$pb.TagNumber(6)
  $19.Timestamp get createdAt => $_getN(5);
  @$pb.TagNumber(6)
  set createdAt($19.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCreatedAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearCreatedAt() => clearField(6);
  @$pb.TagNumber(6)
  $19.Timestamp ensureCreatedAt() => $_ensure(5);

  @$pb.TagNumber(7)
  $19.Timestamp get updatedAt => $_getN(6);
  @$pb.TagNumber(7)
  set updatedAt($19.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasUpdatedAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearUpdatedAt() => clearField(7);
  @$pb.TagNumber(7)
  $19.Timestamp ensureUpdatedAt() => $_ensure(6);
}
