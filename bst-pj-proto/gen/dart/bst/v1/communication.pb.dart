...
class Comment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Comment', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$24.Timestamp>(5, _omitFieldNames ? '' : 'createdAt', subBuilder: $24.Timestamp.create)
    ..aOM<$24.Timestamp>(6, _omitFieldNames ? '' : 'updatedAt', subBuilder: $24.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $24.Timestamp get createdAt => $_getN(4);
  @$pb.TagNumber(5)
  set createdAt($24.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCreatedAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearCreatedAt() => clearField(5);
  @$pb.TagNumber(5)
  $24.Timestamp ensureCreatedAt() => $_ensure(4);

  @$pb.TagNumber(6)
  $24.Timestamp get updatedAt => $_getN(5);
  @$pb.TagNumber(6)
  set updatedAt($24.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpdatedAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearUpdatedAt() => clearField(6);
  @$pb.TagNumber(6)
  $24.Timestamp ensureUpdatedAt() => $_ensure(5);
...
class Thread extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Thread', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$25.User>(4, _omitFieldNames ? '' : 'createdBy', subBuilder: $25.User.create)
    ..aOM<$24.Timestamp>(5, _omitFieldNames ? '' : 'createdAt', subBuilder: $24.Timestamp.create)
    ..aOM<$24.Timestamp>(6, _omitFieldNames ? '' : 'updatedAt', subBuilder: $24.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $25.User get createdBy => $_getN(3);
  @$pb.TagNumber(4)
  set createdBy($25.User v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCreatedBy() => $_has(3);
  @$pb.TagNumber(4)
  void clearCreatedBy() => clearField(4);
  @$pb.TagNumber(4)
  $25.User ensureCreatedBy() => $_ensure(3);
...
class ReactionType extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReactionType', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$24.Timestamp>(6, _omitFieldNames ? '' : 'createdAt', subBuilder: $24.Timestamp.create)
    ..aOM<$24.Timestamp>(7, _omitFieldNames ? '' : 'updatedAt', subBuilder: $24.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $24.Timestamp get createdAt => $_getN(5);
  @$pb.TagNumber(6)
  set createdAt($24.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCreatedAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearCreatedAt() => clearField(6);
  @$pb.TagNumber(6)
  $24.Timestamp ensureCreatedAt() => $_ensure(5);

  @$pb.TagNumber(7)
  $24.Timestamp get updatedAt => $_getN(6);
  @$pb.TagNumber(7)
  set updatedAt($24.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasUpdatedAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearUpdatedAt() => clearField(7);
  @$pb.TagNumber(7)
  $24.Timestamp ensureUpdatedAt() => $_ensure(6);
}
...
class Reaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reaction', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..aOM<$25.User>(2, _omitFieldNames ? '' : 'user', subBuilder: $25.User.create)
  ...
  @$pb.TagNumber(2)
  $25.User get user => $_getN(1);
  @$pb.TagNumber(2)
  set user($25.User v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUser() => $_has(1);
  @$pb.TagNumber(2)
  void clearUser() => clearField(2);
  @$pb.TagNumber(2)
  $25.User ensureUser() => $_ensure(1);
