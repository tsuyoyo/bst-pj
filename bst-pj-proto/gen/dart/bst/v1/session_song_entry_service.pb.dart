...
class AddSongEntryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddSongEntryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$37.SessionSongEntry>(1, _omitFieldNames ? '' : 'entry', subBuilder: $37.SessionSongEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $37.SessionSongEntry get entry => $_getN(0);
  @$pb.TagNumber(1)
  set entry($37.SessionSongEntry v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEntry() => $_has(0);
  @$pb.TagNumber(1)
  void clearEntry() => clearField(1);
  @$pb.TagNumber(1)
  $37.SessionSongEntry ensureEntry() => $_ensure(0);
}
