...
class SessionTimelineDate extends $pb.GeneratedMessage {
  factory SessionTimelineDate({
    ...
    $11.Timestamp? entryOpen,
    $11.Timestamp? entryClose,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionTimelineDate', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$11.Timestamp>(1, _omitFieldNames ? '' : 'createdAt', subBuilder: $11.Timestamp.create)
    ..aOM<$11.Timestamp>(2, _omitFieldNames ? '' : 'entryOpen', subBuilder: $11.Timestamp.create)
    ..aOM<$11.Timestamp>(3, _omitFieldNames ? '' : 'entryClose', subBuilder: $11.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $11.Timestamp get createdAt => $_getN(0);
  @$pb.TagNumber(1)
  set createdAt($11.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreatedAt() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreatedAt() => clearField(1);
  @$pb.TagNumber(1)
  $11.Timestamp ensureCreatedAt() => $_ensure(0);

  @$pb.TagNumber(2)
  $11.Timestamp get entryOpen => $_getN(1);
  @$pb.TagNumber(2)
  set entryOpen($11.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEntryOpen() => $_has(1);
  @$pb.TagNumber(2)
  void clearEntryOpen() => clearField(2);
  @$pb.TagNumber(2)
  $11.Timestamp ensureEntryOpen() => $_ensure(1);

  @$pb.TagNumber(3)
  $11.Timestamp get entryClose => $_getN(2);
  @$pb.TagNumber(3)
  set entryClose($11.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEntryClose() => $_has(2);
  @$pb.TagNumber(3)
  void clearEntryClose() => clearField(3);
  @$pb.TagNumber(3)
  $11.Timestamp ensureEntryClose() => $_ensure(2);
...
class SessionPart extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionPart', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$9.Part>(1, _omitFieldNames ? '' : 'part', subBuilder: $9.Part.create)
  ...
  @$pb.TagNumber(1)
  $9.Part get part => $_getN(0);
  @$pb.TagNumber(1)
  set part($9.Part v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPart() => $_has(0);
  @$pb.TagNumber(1)
  void clearPart() => clearField(1);
  @$pb.TagNumber(1)
  $9.Part ensurePart() => $_ensure(0);
...
class SessionParticipant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionParticipant', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$12.User>(4, _omitFieldNames ? '' : 'user', subBuilder: $12.User.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $12.User get user => $_getN(3);
  @$pb.TagNumber(4)
  set user($12.User v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUser() => $_has(3);
  @$pb.TagNumber(4)
  void clearUser() => clearField(4);
  @$pb.TagNumber(4)
  $12.User ensureUser() => $_ensure(3);
}
...
class SongPerformance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SongPerformance', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$9.Song>(1, _omitFieldNames ? '' : 'song', subBuilder: $9.Song.create)
  ...
  @$pb.TagNumber(1)
  $9.Song get song => $_getN(0);
  @$pb.TagNumber(1)
  set song($9.Song v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSong() => $_has(0);
  @$pb.TagNumber(1)
  void clearSong() => clearField(1);
  @$pb.TagNumber(1)
  $9.Song ensureSong() => $_ensure(0);
...
class TimetableEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimetableEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$11.Timestamp>(3, _omitFieldNames ? '' : 'start', subBuilder: $11.Timestamp.create)
    ..aOM<$11.Timestamp>(4, _omitFieldNames ? '' : 'end', subBuilder: $11.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $11.Timestamp get start => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $11.Timestamp ensureStart() => $_ensure(2);

  @$pb.TagNumber(4)
  $11.Timestamp get end => $_getN(3);
  @$pb.TagNumber(4)
  set end($11.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class Timetable extends $pb.GeneratedMessage {
  factory Timetable({
    ...
    $core.Iterable<$14.Party>? parties,
  }) {
    final $result = create();
    if (entries != null) {
      $result.entries.addAll(entries);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Timetable', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..pc<$14.Party>(4, _omitFieldNames ? '' : 'parties', $pb.PbFieldType.PM, subBuilder: $14.Party.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<$14.Party> get parties => $_getList(3);
}
