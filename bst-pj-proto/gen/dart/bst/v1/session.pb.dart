...
class SessionTimelineDate extends $pb.GeneratedMessage {
  factory SessionTimelineDate({
    ...
    $27.Timestamp? entryOpen,
    $27.Timestamp? entryClose,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionTimelineDate', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$27.Timestamp>(1, _omitFieldNames ? '' : 'createdAt', subBuilder: $27.Timestamp.create)
    ..aOM<$27.Timestamp>(2, _omitFieldNames ? '' : 'entryOpen', subBuilder: $27.Timestamp.create)
    ..aOM<$27.Timestamp>(3, _omitFieldNames ? '' : 'entryClose', subBuilder: $27.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $27.Timestamp get createdAt => $_getN(0);
  @$pb.TagNumber(1)
  set createdAt($27.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreatedAt() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreatedAt() => clearField(1);
  @$pb.TagNumber(1)
  $27.Timestamp ensureCreatedAt() => $_ensure(0);

  @$pb.TagNumber(2)
  $27.Timestamp get entryOpen => $_getN(1);
  @$pb.TagNumber(2)
  set entryOpen($27.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEntryOpen() => $_has(1);
  @$pb.TagNumber(2)
  void clearEntryOpen() => clearField(2);
  @$pb.TagNumber(2)
  $27.Timestamp ensureEntryOpen() => $_ensure(1);

  @$pb.TagNumber(3)
  $27.Timestamp get entryClose => $_getN(2);
  @$pb.TagNumber(3)
  set entryClose($27.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEntryClose() => $_has(2);
  @$pb.TagNumber(3)
  void clearEntryClose() => clearField(3);
  @$pb.TagNumber(3)
  $27.Timestamp ensureEntryClose() => $_ensure(2);
...
class SessionPart extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionPart', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$25.Part>(1, _omitFieldNames ? '' : 'part', subBuilder: $25.Part.create)
  ...
  @$pb.TagNumber(1)
  $25.Part get part => $_getN(0);
  @$pb.TagNumber(1)
  set part($25.Part v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPart() => $_has(0);
  @$pb.TagNumber(1)
  void clearPart() => clearField(1);
  @$pb.TagNumber(1)
  $25.Part ensurePart() => $_ensure(0);
...
class SessionParticipant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionParticipant', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$28.User>(4, _omitFieldNames ? '' : 'user', subBuilder: $28.User.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $28.User get user => $_getN(3);
  @$pb.TagNumber(4)
  set user($28.User v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class SongPerformanceEntry extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set user($28.User v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUser() => $_has(0);
  @$pb.TagNumber(1)
  void clearUser() => clearField(1);
  @$pb.TagNumber(1)
  $28.User ensureUser() => $_ensure(0);
...
class SongPerformance extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set song($25.Song v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class TimetableEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimetableEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$27.Timestamp>(3, _omitFieldNames ? '' : 'start', subBuilder: $27.Timestamp.create)
    ..aOM<$27.Timestamp>(4, _omitFieldNames ? '' : 'end', subBuilder: $27.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $27.Timestamp get start => $_getN(2);
  @$pb.TagNumber(3)
  set start($27.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStart() => $_has(2);
  @$pb.TagNumber(3)
  void clearStart() => clearField(3);
  @$pb.TagNumber(3)
  $27.Timestamp ensureStart() => $_ensure(2);

  @$pb.TagNumber(4)
  $27.Timestamp get end => $_getN(3);
  @$pb.TagNumber(4)
  set end($27.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEnd() => $_has(3);
  @$pb.TagNumber(4)
  void clearEnd() => clearField(4);
  @$pb.TagNumber(4)
  $27.Timestamp ensureEnd() => $_ensure(3);
}
...
class SessionFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionFeedback', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$28.User>(3, _omitFieldNames ? '' : 'user', subBuilder: $28.User.create)
    ..aOM<$27.Timestamp>(4, _omitFieldNames ? '' : 'createdAt', subBuilder: $27.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $28.User get user => $_getN(2);
  @$pb.TagNumber(3)
  set user($28.User v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUser() => $_has(2);
  @$pb.TagNumber(3)
  void clearUser() => clearField(3);
  @$pb.TagNumber(3)
  $28.User ensureUser() => $_ensure(2);

  @$pb.TagNumber(4)
  $27.Timestamp get createdAt => $_getN(3);
  @$pb.TagNumber(4)
  set createdAt($27.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCreatedAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearCreatedAt() => clearField(4);
  @$pb.TagNumber(4)
  $27.Timestamp ensureCreatedAt() => $_ensure(3);
}
