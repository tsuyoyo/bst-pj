...
class SessionTimelineDate extends $pb.GeneratedMessage {
  factory SessionTimelineDate({
    ...
    $12.Timestamp? entryOpen,
    $12.Timestamp? entryClose,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionTimelineDate', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$12.Timestamp>(1, _omitFieldNames ? '' : 'createdAt', subBuilder: $12.Timestamp.create)
    ..aOM<$12.Timestamp>(2, _omitFieldNames ? '' : 'entryOpen', subBuilder: $12.Timestamp.create)
    ..aOM<$12.Timestamp>(3, _omitFieldNames ? '' : 'entryClose', subBuilder: $12.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $12.Timestamp get createdAt => $_getN(0);
  @$pb.TagNumber(1)
  set createdAt($12.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreatedAt() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreatedAt() => clearField(1);
  @$pb.TagNumber(1)
  $12.Timestamp ensureCreatedAt() => $_ensure(0);

  @$pb.TagNumber(2)
  $12.Timestamp get entryOpen => $_getN(1);
  @$pb.TagNumber(2)
  set entryOpen($12.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEntryOpen() => $_has(1);
  @$pb.TagNumber(2)
  void clearEntryOpen() => clearField(2);
  @$pb.TagNumber(2)
  $12.Timestamp ensureEntryOpen() => $_ensure(1);

  @$pb.TagNumber(3)
  $12.Timestamp get entryClose => $_getN(2);
  @$pb.TagNumber(3)
  set entryClose($12.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEntryClose() => $_has(2);
  @$pb.TagNumber(3)
  void clearEntryClose() => clearField(3);
  @$pb.TagNumber(3)
  $12.Timestamp ensureEntryClose() => $_ensure(2);
...
class SessionParticipant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionParticipant', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$13.User>(4, _omitFieldNames ? '' : 'user', subBuilder: $13.User.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $13.User get user => $_getN(3);
  @$pb.TagNumber(4)
  set user($13.User v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUser() => $_has(3);
  @$pb.TagNumber(4)
  void clearUser() => clearField(4);
  @$pb.TagNumber(4)
  $13.User ensureUser() => $_ensure(3);
}
...
class TimetableEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimetableEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$12.Timestamp>(3, _omitFieldNames ? '' : 'start', subBuilder: $12.Timestamp.create)
    ..aOM<$12.Timestamp>(4, _omitFieldNames ? '' : 'end', subBuilder: $12.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $12.Timestamp get start => $_getN(2);
  @$pb.TagNumber(3)
  set start($12.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStart() => $_has(2);
  @$pb.TagNumber(3)
  void clearStart() => clearField(3);
  @$pb.TagNumber(3)
  $12.Timestamp ensureStart() => $_ensure(2);

  @$pb.TagNumber(4)
  $12.Timestamp get end => $_getN(3);
  @$pb.TagNumber(4)
  set end($12.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEnd() => $_has(3);
  @$pb.TagNumber(4)
  void clearEnd() => clearField(4);
  @$pb.TagNumber(4)
  $12.Timestamp ensureEnd() => $_ensure(3);
}
...
class Timetable extends $pb.GeneratedMessage {
  factory Timetable({
    ...
    $core.Iterable<$15.Party>? parties,
  }) {
    final $result = create();
    if (entries != null) {
      $result.entries.addAll(entries);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Timetable', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..pc<$15.Party>(4, _omitFieldNames ? '' : 'parties', $pb.PbFieldType.PM, subBuilder: $15.Party.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<$15.Party> get parties => $_getList(3);
}
