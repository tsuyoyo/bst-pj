...
class SessionTimelineDate extends $pb.GeneratedMessage {
  factory SessionTimelineDate({
    ...
    $10.Timestamp? entryOpen,
    $10.Timestamp? entryClose,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionTimelineDate', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$10.Timestamp>(1, _omitFieldNames ? '' : 'createdAt', subBuilder: $10.Timestamp.create)
    ..aOM<$10.Timestamp>(2, _omitFieldNames ? '' : 'entryOpen', subBuilder: $10.Timestamp.create)
    ..aOM<$10.Timestamp>(3, _omitFieldNames ? '' : 'entryClose', subBuilder: $10.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $10.Timestamp get createdAt => $_getN(0);
  @$pb.TagNumber(1)
  set createdAt($10.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreatedAt() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreatedAt() => clearField(1);
  @$pb.TagNumber(1)
  $10.Timestamp ensureCreatedAt() => $_ensure(0);

  @$pb.TagNumber(2)
  $10.Timestamp get entryOpen => $_getN(1);
  @$pb.TagNumber(2)
  set entryOpen($10.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEntryOpen() => $_has(1);
  @$pb.TagNumber(2)
  void clearEntryOpen() => clearField(2);
  @$pb.TagNumber(2)
  $10.Timestamp ensureEntryOpen() => $_ensure(1);

  @$pb.TagNumber(3)
  $10.Timestamp get entryClose => $_getN(2);
  @$pb.TagNumber(3)
  set entryClose($10.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEntryClose() => $_has(2);
  @$pb.TagNumber(3)
  void clearEntryClose() => clearField(3);
  @$pb.TagNumber(3)
  $10.Timestamp ensureEntryClose() => $_ensure(2);
...
class SessionPart extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionPart', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$8.Part>(1, _omitFieldNames ? '' : 'part', subBuilder: $8.Part.create)
  ...
  @$pb.TagNumber(1)
  $8.Part get part => $_getN(0);
  @$pb.TagNumber(1)
  set part($8.Part v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPart() => $_has(0);
  @$pb.TagNumber(1)
  void clearPart() => clearField(1);
  @$pb.TagNumber(1)
  $8.Part ensurePart() => $_ensure(0);
...
class SongPerformance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SongPerformance', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..aOM<$8.Song>(1, _omitFieldNames ? '' : 'song', subBuilder: $8.Song.create)
  ...
  @$pb.TagNumber(1)
  $8.Song get song => $_getN(0);
  @$pb.TagNumber(1)
  set song($8.Song v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSong() => $_has(0);
  @$pb.TagNumber(1)
  void clearSong() => clearField(1);
  @$pb.TagNumber(1)
  $8.Song ensureSong() => $_ensure(0);
...
class TimetableEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimetableEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$10.Timestamp>(3, _omitFieldNames ? '' : 'start', subBuilder: $10.Timestamp.create)
    ..aOM<$10.Timestamp>(4, _omitFieldNames ? '' : 'end', subBuilder: $10.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $10.Timestamp get start => $_getN(2);
  @$pb.TagNumber(3)
  set start($10.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStart() => $_has(2);
  @$pb.TagNumber(3)
  void clearStart() => clearField(3);
  @$pb.TagNumber(3)
  $10.Timestamp ensureStart() => $_ensure(2);

  @$pb.TagNumber(4)
  $10.Timestamp get end => $_getN(3);
  @$pb.TagNumber(4)
  set end($10.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEnd() => $_has(3);
  @$pb.TagNumber(4)
  void clearEnd() => clearField(4);
  @$pb.TagNumber(4)
  $10.Timestamp ensureEnd() => $_ensure(3);
}
...
class Timetable extends $pb.GeneratedMessage {
  factory Timetable({
    ...
    $core.Iterable<$13.Party>? parties,
  }) {
    final $result = create();
    if (entries != null) {
      $result.entries.addAll(entries);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Timetable', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..pc<$13.Party>(4, _omitFieldNames ? '' : 'parties', $pb.PbFieldType.PM, subBuilder: $13.Party.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<$13.Party> get parties => $_getList(3);
}
