...
class Party extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Party', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..aOM<$32.Timestamp>(4, _omitFieldNames ? '' : 'startAt', subBuilder: $32.Timestamp.create)
    ..aOM<$32.Timestamp>(5, _omitFieldNames ? '' : 'endAt', subBuilder: $32.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $32.Timestamp get startAt => $_getN(3);
  @$pb.TagNumber(4)
  set startAt($32.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasStartAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearStartAt() => clearField(4);
  @$pb.TagNumber(4)
  $32.Timestamp ensureStartAt() => $_ensure(3);

  @$pb.TagNumber(5)
  $32.Timestamp get endAt => $_getN(4);
  @$pb.TagNumber(5)
  set endAt($32.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasEndAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearEndAt() => clearField(5);
  @$pb.TagNumber(5)
  $32.Timestamp ensureEndAt() => $_ensure(4);
}
