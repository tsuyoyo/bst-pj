...
class CreateRatingRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateRatingRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ...
    ..e<$7.RatingTargetType>(2, _omitFieldNames ? '' : 'targetType', $pb.PbFieldType.OE, protoName: 'targetType', defaultOrMaker: $7.RatingTargetType.RATING_TARGET_TYPE_UNSPECIFIED, valueOf: $7.RatingTargetType.valueOf, enumValues: $7.RatingTargetType.values)
  ...
  @$pb.TagNumber(2)
  $7.RatingTargetType get targetType => $_getN(1);
  @$pb.TagNumber(2)
  set targetType($7.RatingTargetType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ListRatingsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRatingsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..e<$7.RatingTargetType>(1, _omitFieldNames ? '' : 'targetType', $pb.PbFieldType.OE, protoName: 'targetType', defaultOrMaker: $7.RatingTargetType.RATING_TARGET_TYPE_UNSPECIFIED, valueOf: $7.RatingTargetType.valueOf, enumValues: $7.RatingTargetType.values)
  ...
  @$pb.TagNumber(1)
  $7.RatingTargetType get targetType => $_getN(0);
  @$pb.TagNumber(1)
  set targetType($7.RatingTargetType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ListRatingsResponse extends $pb.GeneratedMessage {
  factory ListRatingsResponse({
    $core.Iterable<$7.Rating>? ratings,
    $core.int? totalCount,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRatingsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'bst.v1'), createEmptyInstance: create)
    ..pc<$7.Rating>(1, _omitFieldNames ? '' : 'ratings', $pb.PbFieldType.PM, subBuilder: $7.Rating.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$7.Rating> get ratings => $_getList(0);
